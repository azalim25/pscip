        ...
        <div className="py-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white px-8 py-3.5 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all active:scale-95 shadow-lg shadow-red-600/20"
            >
