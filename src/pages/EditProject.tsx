                ...
                >
                    <div className="p-8 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-slate-800">Editar Detalhes</h2>
                                <p className="text-slate-500 text-sm font-medium">Altere as informações conforme necessário</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
