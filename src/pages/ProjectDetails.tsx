...
function OccupancySafetyMeasures({
    ...
    const isG5 = occupancy?.includes('G-5') || (isIntegrated && project.mixed_occupancies?.some(m => m.occupancy.includes('G-5')));
    ...
    if (isPT || isGroupA2A3) {
        ...
        const filteredAdv = advMeasures.filter(m => {
            ...
            if (isG1G2) {
                ...
                if (m.title === "Hidrantes e Mangotinhos") return true;
                if (m.title === "Chuveiros Automáticos" && height > 30) return true;
                if (m.title === "Brigada de Incêndio" && height > 30) return true;
                if (m.title === "Alarme de Incêndio" && height > 12) return true;
                if (m.title === "CMAR" && height > 30) return true;
            }
            if (isG3) {
                if (m.title === "Acesso de Viaturas") return true;
                if (m.title === "Hidrantes e Mangotinhos") return true;
                if (m.title === "Brigada de Incêndio") return true;
                if (m.title === "Alarme de Incêndio") return true;
            }
            if (isG4) {
                if (m.title === "Acesso de Viaturas") return true;
                if (m.title === "Segurança Estrutural") return true;
                ...
                if (m.title === "Brigada de Incêndio") return true;
                if (m.title === "Alarme de Incêndio") return true;
                if (m.title === "CMAR" && height > 12) return true;
                if (m.title === "Detecção de Incêndio" && height > 30) return true;
            }
            if (isG5) {
                if (m.title === "Acesso de Viaturas") return true;
                if (m.title === "Segurança Estrutural") return true;
                ...
                if (m.title === "Brigada de Incêndio") return true;
                if (m.title === "Alarme de Incêndio") return true;
                if (m.title === "CMAR") return true;
                if (m.title === "Detecção de Incêndio" && height > 12) return true;
                if (m.title === "Plano de Intervenção") return true;
            }
            if (isGroupE) {
